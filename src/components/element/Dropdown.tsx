...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <i className="ri-arrow-down-s-line h-6 w-6 transition-transform duration-200" />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'text-body-1-r focus:text-subhead-2-b relative flex w-full cursor-default items-center rounded-sm py-3 pr-4 pl-4 outline-none select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
      className,
    )}
    {...props}
  >
