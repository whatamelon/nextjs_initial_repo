...
const persistConfig = {
  ...
  whitelist: [authSlice.reducerPath], // 해당 slice만 localStorage에 저장하겠다는 의미
...
export const makeStore = () =>
  configureStore({
    ...
    middleware: (getDefaultMiddleware) =>
      ...
      }).concat(userSessionMiddleware, authApiSlice.middleware as unknown as Middleware<unknown, RootState>),
  })
